// menu style
const menuListStyle = 'font-ChosunGU mx-4 text-base leading-snug text-surface hover:text-graylv3 font-medium capitalize';

// mobile menu style
const mobileMenuStyle = 'm-0 block py-4 px-6';

// blog style과 notebook style
const posth1Style = 'text-[40px] font-ChosunGU font-bold mb-4 mt-6 border-b border-graylv2 pb-2.5';
const posth2Style = 'text-[32px] font-ChosunGU font-bold mb-4 mt-6 border-b border-graylv2 pb-2.5';
const posth3Style = 'text-[28px] font-ChosunGU font-bold mb-4 mt-6 border-b border-graylv2 pb-2.5';
const posth4Style = 'text-2xl font-ChosunGU font-bold mb-2 mt-4';
const posth5Style = 'text-xl font-ChosunGU font-bold mb-2 mt-4';
const posth6Style = 'text-lg font-ChosunGU font-bold mb-2 mt-4';
...
const postcodeStyle = 'font-ChosunGU text-base bg-transparent';
...
const posttbodyStyle = 'font-ChosunGU text-left';
...
const postemStyle = 'font-ChosunGU text-lg font-medium italic pr-0.5';
const poststrongStyle = 'font-ChosunGU text-lg font-bold';
...
const notebookcodeStyle = 'font-ChosunGU text-base bg-graylv1';
...
const bloglistFirstCardDescriptionStyle = 'font-ChosunGU text-white text-base font-normal leading-snug md:max-h-40 md:line-clamp-[7] line-clamp-3 mb-3';
...
const bloglistCardTitleStyle = 'font-ChosunGU text-gray-600 font-bold text-2xl mb-3';
...
const bloglistCardDescriptionStyle = 'font-ChosunGU text-white text-base font-normal leading-snug h-auto md:h-16 line-clamp-3 mb-3';
...
const bloglistCardDateStyle = 'font-ChosunGU text-white text-sm inline-block font-normal';
...
const pageNumberActiveStyle = 'font-ChosunGU text-primary font-bold';

// category 검색 영역 스타일
const categoryContainerStyle = 'flex-col md:w-[220px] overflow-y-auto rounded-md bg-white shadow-sm z-10';
const categoryItemStyle      = 'font-ChosunGU text-base font-normal px-5 py-[9px] cursor-pointer hover:bg-graylv1 transition duration-200 ease-in-out';
const categoryItemCountStyle = 'font-ChosunGU text-base font-normal text-graylv3 ml-1';
