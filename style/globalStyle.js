...
// category 스타일
const categoryContainerStyle = `flex flex-col md:w-[220px] overflow-y-auto rounded-md bg-transparent shadow-none z-10`;const categoryItemStyle = `text-base font-normal px-5 py-[9px] cursor-pointer hover:bg-graylv1 transition duration-200 ease-in-out`;
